...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0000036e4342464b9aef60e12a8189613d3165df72e0c0220afea7f4804dadbc"));
    //(500, uint256("0x0000042ff28adc30c4ebe9faa16e8a014bd9e327866413e0e536687e7c789c65"));// genesis
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1594551571, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 4402;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // TimelockCoin starting difficulty is 1 / 2^12
        ...
        nMasternodeRewardMaturity = 15;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 500;
        nTimelockCoinBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nTimelockCoinBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "There are no heroes in a punk rock band.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1594551571;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 164144;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0000036e4342464b9aef60e12a8189613d3165df72e0c0220afea7f4804dadbc"));
        assert(genesis.hashMerkleRoot == uint256("94b4a7d021a1995f4e6184172be37f899da5a9aee0035d21a951bd54b2f11fdd"));

        vSeeds.push_back(CDNSSeedData("45.63.7.205", "45.63.7.205"));
        vSeeds.push_back(CDNSSeedData("140.82.60.10", "140.82.60.10"));
        vSeeds.push_back(CDNSSeedData("45.77.216.228", "45.77.216.228"));
        vSeeds.push_back(CDNSSeedData("45.76.5.92", "45.76.5.92"));
        vSeeds.push_back(CDNSSeedData("45.63.5.168", "45.63.5.168"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nTimelockCoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nTimelockCoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 100;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "timelockcoin-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "timelockcoin-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.timelockcoin.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet timelockcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet timelockcoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet timelockcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet timelockcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet timelockcoin BIP44 coin type is '1' (All coin's testnet default)
