...
#ifndef TimelockCoin_STAKEINPUT_H
#define TimelockCoin_STAKEINPUT_H
...
public:
    ...
    bool IsZTYM() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZTYM() override { return false; }
...
#endif //TimelockCoin_STAKEINPUT_H
