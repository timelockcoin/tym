...
// Copyright (c) 2015-2018 The TimelockCoin developers
...
/* TimelockCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TimelockCoin"
#define QAPP_ORG_DOMAIN "timelockcoin.org"
#define QAPP_APP_NAME_DEFAULT "TimelockCoin-Qt"
#define QAPP_APP_NAME_TESTNET "TimelockCoin-Qt-testnet"
