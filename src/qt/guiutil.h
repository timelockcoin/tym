...
/** Utility functions used by the timelockcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render timelockcoin addresses in monospace font
...
// Parse "timelockcoin:" URI into recipient object, return true on successful parsing
