// Copyright (c) 2017-2020 The TimelockCoin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zTYM Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zTYM.";
            else if (!mint.isSeedCorrect)
                strReason = "The zTYM seed used to mint this zTYM is not the same as currently hold in the wallet";
            else
