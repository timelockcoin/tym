...
WalletModel::WalletModel(CWallet* wallet, OptionsModel* optionsModel, QObject* parent) : QObject(parent), wallet(wallet), optionsModel(optionsModel), addressTableModel(0),
                                                                                         ...
                                                                                         cachedLockedCollateralBalance(0), cachedEncryptionStatus(Unencrypted),
                                                                                         cachedNumBlocks(0)
{
...
CAmount WalletModel::getBalance(const CCoinControl* coinControl, bool fIncludeDelegated) const
{
    ...
    return wallet->GetBalance(fIncludeDelegated) - wallet->GetImmatureCollateral();
}
...
void WalletModel::emitBalanceChanged()
{
    ...
    Q_EMIT balanceChanged(cachedBalance, cachedUnconfirmedBalance, cachedImmatureBalance,
                        ...
                        cachedDelegatedBalance, cachedColdStakedBalance, cachedLockedCollateralBalance);
}
...
void WalletModel::checkBalanceChanged()
{
    ...
    if (cachedBalance != newBalance || cachedUnconfirmedBalance != newUnconfirmedBalance || cachedImmatureBalance != newImmatureBalance || cachedLockedCollateralBalance != newLockedCollateralBalance ||
        ...
        Q_EMIT balanceChanged(newBalance, newUnconfirmedBalance, newImmatureBalance,
                            ...
                            newDelegatedBalance, newColdStakedBalance, newLockedCollateralBalance);
    }
}
