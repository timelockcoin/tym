...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR TYM</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                TimelockCoinGUI* window = static_cast<TimelockCoinGUI*>(parentWidget());
...
{
    TimelockCoinGUI* gui = static_cast<TimelockCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<TimelockCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("TimelockCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your TYMs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
