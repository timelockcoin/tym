...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TimelockCoin Core"),
     ...
     * override -datadir in the timelockcoin.conf file in the default data directory
     * (to be consistent with timelockcoind behavior)
     */
