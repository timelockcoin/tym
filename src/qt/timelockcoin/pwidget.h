...
#include <QWidget>
#include <QString>
#include "qt/timelockcoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(timelockcoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    timelockcoinGUI* getWindow() { return this->window; }
...
protected:
    timelockcoinGUI* window = nullptr;
