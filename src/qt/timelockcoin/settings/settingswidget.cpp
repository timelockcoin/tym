...
#include "qt/timelockcoin/settings/settingswidget.h"
#include "qt/timelockcoin/settings/forms/ui_settingswidget.h"
...
#include "qt/timelockcoin/settings/settingswalletoptionswidget.h"
#include "qt/timelockcoin/settings/settingsmainoptionswidget.h"
#include "qt/timelockcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/timelockcoin/settings/settingsmultisendwidget.h"
...
SettingsWidget::SettingsWidget(TimelockCoinGUI* parent) :
    PWidget(parent),
