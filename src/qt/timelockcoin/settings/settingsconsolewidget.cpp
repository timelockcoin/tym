...
#include "qt/timelockcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/timelockcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(timelockcoinGUI* _window, QWidget *parent) :
