...
#include "qt/timelockcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(timelockcoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("timelockcoin_tx_csv_export(*.csv)") : tr("timelockcoin_addresses_csv_export(*.csv)"),
                                        nullptr);
