...
#include "qt/timelockcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/timelockcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(timelockcoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to timelockcoinGUI::handleRestart()
