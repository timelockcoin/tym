    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of TYM staked."));
    ...
    ui->labelAmountPiv->setText("0 TYM");
    ...
    ui->btnHowTo->setText(tr("How to get TYM"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("TYM")
    updateDisplayUnit();
}
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZTYM;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair TYM, zTYM
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("TYM");
    set1 = new QBarSet("zTYM");
    set0->setColor(QColor(102, 141, 170));
    set1->setColor(QColor(0, 62, 117));
