...
#include "qt/timelockcoin/forms/ui_receivewidget.h"
...
#include "qt/timelockcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(TimelockCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive TYM."));
