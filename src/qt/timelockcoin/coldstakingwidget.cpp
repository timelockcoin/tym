...
#include "qt/timelockcoin/forms/ui_coldstakingwidget.h"
#include "qt/timelockcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/timelockcoin/requestdialog.h"
#include "qt/timelockcoin/tooltipmenu.h"
#include "qt/timelockcoin/furlistrow.h"
...
#include "qt/timelockcoin/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(TimelockCoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your TYMs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept TYM delegation / Delegate TYM"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select TYM outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 TYM" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
