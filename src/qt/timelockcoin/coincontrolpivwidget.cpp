...
#include "qt/timelockcoin/coincontrolpivwidget.h"
#include "qt/timelockcoin/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select TYM Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("TYM");
    ...
    ui->labelValueAfter->setText("0.00 TYM");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 TYM");
    ui->labelValueFee->setText("0.00 TYM");
