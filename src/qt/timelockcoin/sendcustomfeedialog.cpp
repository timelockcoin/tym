...
#include "qt/timelockcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(timelockcoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &timelockcoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
