...
#include "qt/timelockcoin/navmenuwidget.h"
#include "qt/timelockcoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(TimelockCoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-timelockcoin");
