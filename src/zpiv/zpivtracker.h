...
#ifndef TimelockCoin_ZTYMTRACKER_H
#define TimelockCoin_ZTYMTRACKER_H
...
public:
    CzTYMTracker(std::string strWalletFile);
    ~CzTYMTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzTYMWallet* zTYMWallet = NULL);
...
#endif //TimelockCoin_ZTYMTRACKER_H
