// Copyright (c) 2017-2018 The TimelockCoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef TimelockCoin_ZTYMWALLET_H
#define TimelockCoin_ZTYMWALLET_H
...
public:
    CzTYMWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZTYM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZTYM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //TimelockCoin_ZTYMWALLET_H
