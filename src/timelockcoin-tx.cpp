...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TimelockCoin Core timelockcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  timelockcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded timelockcoin transaction") + "\n" +
                               "  timelockcoin-tx [options] -create [commands]   " + _("Create hex-encoded timelockcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded timelockcoin transaction
