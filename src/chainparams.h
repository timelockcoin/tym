 ...
 * TimelockCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int MN_REWARD_MATURITY() const { return nMasternodeRewardMaturity; }
    ...
    int TimelockCoinBadBlockTime() const { return nTimelockCoinBadBlockTime; }
    int TimelockCoinBadBlocknBits() const { return nTimelockCoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nTimelockCoinBadBlockTime;
    unsigned int nTimelockCoinBadBlocknBits;
