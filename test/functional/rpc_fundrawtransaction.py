...
class RawTransactionsTest(TimelockCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid timelockcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid timelockcoin address" in e.error['message'])
