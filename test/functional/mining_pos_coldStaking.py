...
from test_framework.timelockcoin_node import TimelockCoinTestNode
...
class TimelockCoin_ColdStakingTest(TimelockCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(TimelockCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 TYM from the pot)
...
if __name__ == '__main__':
    TimelockCoin_ColdStakingTest().main()
