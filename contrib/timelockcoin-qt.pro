...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/timelockcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/timelockcoin-cli.cpp \
           src/timelockcoin-tx.cpp \
           src/timelockcoin.cpp \
           src/db.cpp \
           ...
           src/test/test_timelockcoin.cpp \
...
RESOURCES += src/qt/timelockcoin.qrc src/qt/timelockcoin_locale.qrc

TRANSLATIONS += src/qt/locale/timelockcoin_bg.ts \
                src/qt/locale/timelockcoin_de.ts \
                src/qt/locale/timelockcoin_en.ts \
                src/qt/locale/timelockcoin_es.ts \
                src/qt/locale/timelockcoin_fi.ts \
                src/qt/locale/timelockcoin_fr.ts \
                src/qt/locale/timelockcoin_it.ts \
                src/qt/locale/timelockcoin_ja.ts \
                src/qt/locale/timelockcoin_pl.ts \
                src/qt/locale/timelockcoin_pt.ts \
                src/qt/locale/timelockcoin_ru.ts \
                src/qt/locale/timelockcoin_sk.ts \
                src/qt/locale/timelockcoin_sv.ts \
                src/qt/locale/timelockcoin_vi.ts \
                src/qt/locale/timelockcoin_zh_CN.ts \
                src/qt/locale/timelockcoin_zh_TW.ts
