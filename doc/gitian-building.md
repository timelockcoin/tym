...
*Setup instructions for a gitian build of timelockcoin using a VM or physical system.*
...
- [Building timelockcoin](#building-timelockcoin-core)
...
[gitian.sigs](https://github.com/timelockcoinvps-project/gitian.sigs/) repository:
...
You can also mail the files to Fuzzbawls (fuzzbawls@timelockcoin.trade) and he will commit them.
