...
The script [extract-osx-sdk.sh](https://github.com/timelockcoinvps-project/timelockcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
timelockcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/timelockcoinvps-project/timelockcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
